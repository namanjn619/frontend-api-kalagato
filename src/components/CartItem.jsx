...
const CartItem = ({ item }) => {
  ...
  const { id, title, thumbnail, amount, price } = item;
  return (
      ...
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="flex justify-between mb-2">
            <Link
              className="text-sm uppercase max-w-[240px] font-semibold mb-1 hover:underline"
              to={`/product/${id}`}
            >
              {title}
            </Link>
          ...
          <div className="flex gap-x-2 h-[36px] text-sm">
            ...
            <div className="flex-1 flex justify-end items-center font-semibold mb-1">
